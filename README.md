...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 8e0508c2-4d1b-4f04-af2d-8853d4501db3
```

> `8e0508c2-4d1b-4f04-af2d-8853d4501db3` is the password of the certificate, you can change it to any password you want.
